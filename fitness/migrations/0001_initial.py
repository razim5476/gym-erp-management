    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plan_period', models.CharField(choices=[('day', 'Day'), ('week', 'Week'), ('year', 'Year')])),
                ('plan_length', models.PositiveBigIntegerField()),
                ('max_sessions', models.PositiveIntegerField(blank=True, help_text='For PT packages', null=True)),
            ],
            options={
